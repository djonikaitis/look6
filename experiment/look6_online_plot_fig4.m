...
if strcmp(plot_var1, 'texture')
    ...
    dat1 = expsetup.stim.edata_texture_on(tid,1);
...
if strcmp(plot_var1, 'texture')
    ...
    % Create condition matrix
    ind1 = strcmp(expsetup.stim.edata_error_code, 'correct') & ...
        expsetup.stim.esetup_background_texture_on == 0;
    expcond(ind1) = 2;
...
elseif strcmp(plot_var1, 'memory')
    ...
    for i = 1:numel(theta)
        ind1 = strcmp(expsetup.stim.edata_error_code, 'correct') & ...
            expsetup.stim.esetup_background_texture_on == 1 & ...
            expsetup.stim.esetup_block_cond == expsetup.stim.esetup_block_cond(tid) & ...
