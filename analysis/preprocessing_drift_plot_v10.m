...
for i=1:2
    ...
    ylabel(hb,'Trial numbers', 'FontSize', settings.font_size_label)
    axis equal
    
    % X & Y labels
    sacc1_x_label = 'X position';
    sacc1_y_label = 'Y position';
    xlabel (sacc1_x_label, 'FontSize', settings.font_size_label)
    ylabel (sacc1_y_label, 'FontSize', settings.font_size_label)
    ...
    title(title_text, 'FontSize', settings.font_size_label)
...
for i=1:2
    ...
    % Add legend
    text(100, a-a*0.1, 'Individual trials', 'Color', settings.color1(1,:),  'FontSize', settings.font_size_label, 'HorizontalAlignment', 'left')
    text(100, a-a*0.2, 'Moving mean/median', 'Color', settings.color1(2,:),  'FontSize', settings.font_size_label, 'HorizontalAlignment', 'left')
