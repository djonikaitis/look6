...
for i_fig1 = 1:numel(task_names_used)
    ...
    for i_fig2 = 1:numel(orientations_used)
        ...
        orientation_current = orientations_used(i_fig2);
        ...
        if test1_copy(1, i_fig1, i_fig2)>0
            ...
            % Figure title
            if extended_title==0
                plot_set.figure_title = sprintf('%s, tex %s', task_name_current, num2str(orientation_current));
                extended_title = 1;
            else
    ...
    if fig_plot_on>0
        ...
        plot_set.figure_save_name = sprintf ('%s_fig%s_%s', settings.neuron_name, num2str(settings.figure_current), task_name_current);
